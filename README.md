...
[`docs/architecture/adr/`](docs/architecture/adr/) (ADRs 0001-0009), incluyendo un mapa
...
- [x] Rate limits explícitos de AI Gateway + model routing real (70/30 entre dos modelos) vía Unity AI Gateway (ADR 0008, 0009)
